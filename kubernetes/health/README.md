...
`https://health.nature.leafbit.uk/healthz` → `ok`
...
- Type: HTTP
- Target: `https://health.nature.leafbit.uk/healthz`
...
curl -sS https://health.nature.leafbit.uk/healthz   # -> ok
curl -sS -o /dev/null -w '%{http_code}\n' https://health.nature.leafbit.uk/   # -> 404
```
